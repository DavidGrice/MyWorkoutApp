...
const RemoveWorkout = ({navigation, route}) => {
        ...
        return (
          <View
            ...
            style={styles.buttonDates}>
                <Button title={textDate} color="salmon" onPress={() => navigation.navigate("RemoveWorkoutHistorySummary", { date: item.workout_date})}></Button>
          </View>
        );
      };
